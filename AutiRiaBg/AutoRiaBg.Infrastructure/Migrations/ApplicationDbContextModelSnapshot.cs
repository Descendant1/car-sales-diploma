...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoRiaBg.Domain.Entities.AdditionalService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AutoRiaBg.Domain.Entities.CarAd", b =>
                {
                    ...
                    b.Property<float?>("HighwayConsumption")
                        .HasColumnType("real");
                    ...
                    b.Property<string>("LicencePlates")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Mileage")
                        .HasColumnType("int");

                    b.Property<float?>("MixedConsumption")
                        .HasColumnType("real");
                    ...
                    b.Property<int>("YearManagactured")
                        .HasColumnType("int");

                    b.Property<float>("ZeroToHundredInSeconds")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("AutoRiaBg.Domain.Entities.CarPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AutoRiaBg.Domain.Entities.CarAd", b =>
                {
                    b.HasOne("AutoRiaBg.Domain.Entities.Car", "Car")
                        .WithMany()
                        .HasForeignKey("CarId");
            ...
            modelBuilder.Entity("AutoRiaBg.Domain.Entities.CarPhoto", b =>
                {
                    b.HasOne("AutoRiaBg.Domain.Entities.CarAd", "Car")
                        .WithMany("Photos")
                        .HasForeignKey("CarId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AutoRiaBg.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
